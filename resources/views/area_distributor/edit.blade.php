                                        ...
                                        <div class="ad-project-row" data-project-row>
                                            ...
                                            <div class="row align-items-end">
                                                ...
                                                <div class="col-md-5 mb-2">
                                                    ...
                                                    <select class="form-select select2 ad-row-area-name" name="rows[{{ $areaIndex }}][area_name]" data-placeholder="Select Area" required>
...
<script>
    (function () {
        ...
        const areaOptions = @json($areas->pluck('name')->values());
        const saved = {
        ...
        function syncProjectAreaVisibility() {
            ...
            rows.forEach(row => {
                ...
                const project = row.querySelector('.ad-row-project-type')?.value || '';
        ...
        function addProjectAreaRow() {
            ...
            template.innerHTML = `
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-5 mb-2">
                        <label class="form-label">Awarded Area <span class="text-danger">*</span></label>
                        <select class="form-select select2 ad-row-area-name" name="rows[${index}][area_name]" data-placeholder="Select Area" required>
                            <option value="">Select Area</option>
                            ${areaOptionsHtml}
                        </select>
                    </div>
        ...
        modal.querySelectorAll('.project-type').forEach(input => {
            input.addEventListener('change', syncProjectAreaVisibility);
        });

        modal.querySelector('.ad-add-project-row')?.addEventListener('click', addProjectAreaRow);
